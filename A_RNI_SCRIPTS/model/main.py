...
if __name__ == "__main__":
    ...
    print("test_bench_filepath =", test_bench_filepath)
    ...
    with open(model_filepath, mode='r', encoding='utf8') as model_file:
        ...
        write_header(output_model_dict, header_filepath, weight_type_lenght, membrane_type_lenght, add_membrane_probe, membrane_probe_lenght)
