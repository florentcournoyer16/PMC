...
def main():
    ...
    if Path.exists(INPUT_FILE_PATH):
        ...
        output_model_dict = write_header(input_model_dict, OUTPUT_HEADER_PATH, WEIGHT_TYPE_LENGHT, MEMBRANE_TYPE_LENGHT, ADD_PROBE, PROBE_LENGHT)
        write_code(OUTPUT_CODE_PATH, NETWORK_NAME, output_model_dict, ADD_PROBE)
    else:
