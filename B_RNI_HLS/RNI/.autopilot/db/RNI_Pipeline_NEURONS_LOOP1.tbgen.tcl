set moduleName RNI_Pipeline_NEURONS_LOOP1
set isTopModule 0
...
set C_modelName {RNI_Pipeline_NEURONS_LOOP1}
...
set portList { 
	...
	{ NEURONS_MEMBRANE_address0 sc_out sc_lv 6 signal 0 } 
	{ NEURONS_MEMBRANE_ce0 sc_out sc_logic 1 signal 0 } 
	{ NEURONS_MEMBRANE_we0 sc_out sc_logic 1 signal 0 } 
	{ NEURONS_MEMBRANE_d0 sc_out sc_lv 8 signal 0 } 
	{ NEURONS_MEMBRANE_address1 sc_out sc_lv 6 signal 0 } 
	{ NEURONS_MEMBRANE_ce1 sc_out sc_logic 1 signal 0 } 
	{ NEURONS_MEMBRANE_q1 sc_in sc_lv 8 signal 0 } 
}
set NewPortList {[ 
