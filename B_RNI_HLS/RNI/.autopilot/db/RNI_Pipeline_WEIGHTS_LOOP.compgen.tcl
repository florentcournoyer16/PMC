...
set id 11
set name RNI_mac_muladd_8s_8s_8ns_8_4_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { NEURONS_MEMBRANE_load { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { input_list_1_1_reload { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { input_list_2_1_reload { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { input_list_3_1_reload { I 8 vector } } \
} "
}
