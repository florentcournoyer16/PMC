...
set C_modelArgList {
	{ layer_index_val int 2 regular  }
	{ NEURONS_STATE int 1 regular {array 40 { 2 3 } 1 1 } {global 2}  }
	{ NEURONS_MEMBRANE int 8 regular {array 40 { 2 3 } 1 1 } {global 2}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer_index_val", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer_index_val sc_in sc_lv 2 signal 0 } 
	{ NEURONS_STATE_address0 sc_out sc_lv 6 signal 1 } 
	...
	{ NEURONS_MEMBRANE_address0 sc_out sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer_index_val", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "layer_index_val", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6", "Max" : "132351"}
	, {"Name" : "Interval", "Min" : "6", "Max" : "132351"}
]}
...
set Spec2ImplPortList { 
	layer_index_val { ap_none {  { layer_index_val in_data 0 2 } } }
	NEURONS_STATE { ap_memory {  { NEURONS_STATE_address0 mem_address 1 6 }  { NEURONS_STATE_ce0 mem_ce 1 1 }  { NEURONS_STATE_we0 mem_we 1 1 }  { NEURONS_STATE_d0 mem_din 1 1 }  { NEURONS_STATE_q0 mem_dout 0 1 } } }
