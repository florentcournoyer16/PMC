...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { NEURONS_STATE_address0 { O 6 vector } NEURONS_STATE_ce0 { O 1 bit } NEURONS_STATE_q0 { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { neuron_index_1 { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln73_1 \
    op interface \
    ports { sext_ln73_1 { I 8 vector } } \
} "
}
