...
using hls::sim::Byte;
extern "C" void RNI(Byte<4>*, int, int);
extern "C" void apatb_RNI_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 4;
...
__xlx_input_r_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_offset_param_output_r = 4;
  int __xlx_offset_byte_param_output_r = 4*4;
  // DUT call
  RNI(__xlx_input_r_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_output_r);
