set moduleName RNI_Pipeline_NEURONS_LOOP_4
set isTopModule 0
...
set C_modelName {RNI_Pipeline_NEURONS_LOOP_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ NEURONS_MEMBRANE int 16 regular {array 244 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "NEURONS_MEMBRANE", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set Spec2ImplPortList { 
	NEURONS_MEMBRANE { ap_memory {  { NEURONS_MEMBRANE_address0 mem_address 1 8 }  { NEURONS_MEMBRANE_ce0 mem_ce 1 1 }  { NEURONS_MEMBRANE_we0 mem_we 1 1 }  { NEURONS_MEMBRANE_d0 mem_din 1 16 } } }
}
