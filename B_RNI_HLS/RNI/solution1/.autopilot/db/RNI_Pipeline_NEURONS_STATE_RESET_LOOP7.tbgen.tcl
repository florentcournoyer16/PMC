set moduleName RNI_Pipeline_NEURONS_STATE_RESET_LOOP7
set isTopModule 0
...
set C_modelName {RNI_Pipeline_NEURONS_STATE_RESET_LOOP7}
...
set portList { 
	...
	{ NEURONS_STATE_address0 sc_out sc_lv 9 signal 0 } 
