set moduleName RNI_Pipeline_VITIS_LOOP_27_2
set isTopModule 0
...
set C_modelName {RNI_Pipeline_VITIS_LOOP_27_2}
...
set C_modelArgList {
	...
	{ in_pkts_dest_0_0102 int 6 regular  }
	{ in_pkts_id_0_0101 int 5 regular  }
	{ in_pkts_last_0_099 int 1 regular  }
	{ in_pkts_user_0_098 int 2 regular  }
	{ in_pkts_strb_0_097 int 4 regular  }
	{ in_pkts_keep_0_096 int 4 regular  }
	...
	{ out_pkts_last_out int 1 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_pkts_data_3_08", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_pkts_dest_0_0102", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "in_pkts_id_0_0101", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "in_pkts_last_0_099", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "in_pkts_user_0_098", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "in_pkts_strb_0_097", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "in_pkts_keep_0_096", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out_pkts_last_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ in_pkts_dest_0_0102 sc_in sc_lv 6 signal 4 } 
	{ in_pkts_id_0_0101 sc_in sc_lv 5 signal 5 } 
	{ in_pkts_last_0_099 sc_in sc_lv 1 signal 6 } 
	{ in_pkts_user_0_098 sc_in sc_lv 2 signal 7 } 
	{ in_pkts_strb_0_097 sc_in sc_lv 4 signal 8 } 
	{ in_pkts_keep_0_096 sc_in sc_lv 4 signal 9 } 
	{ in_stream_TDATA sc_in sc_lv 32 signal 10 } 
	{ in_stream_TREADY sc_out sc_logic 1 inacc 16 } 
	{ in_stream_TKEEP sc_in sc_lv 4 signal 11 } 
	{ in_stream_TSTRB sc_in sc_lv 4 signal 12 } 
	{ in_stream_TUSER sc_in sc_lv 2 signal 13 } 
	{ in_stream_TLAST sc_in sc_lv 1 signal 14 } 
	{ in_stream_TID sc_in sc_lv 5 signal 15 } 
	{ in_stream_TDEST sc_in sc_lv 6 signal 16 } 
	{ in_pkts_data_3_1_out sc_out sc_lv 32 signal 17 } 
	{ in_pkts_data_3_1_out_ap_vld sc_out sc_logic 1 outvld 17 } 
	{ in_pkts_data_2_1_out sc_out sc_lv 32 signal 18 } 
	{ in_pkts_data_2_1_out_ap_vld sc_out sc_logic 1 outvld 18 } 
	{ in_pkts_data_1_1_out sc_out sc_lv 32 signal 19 } 
	{ in_pkts_data_1_1_out_ap_vld sc_out sc_logic 1 outvld 19 } 
	{ in_pkts_data_0_1_out sc_out sc_lv 32 signal 20 } 
	{ in_pkts_data_0_1_out_ap_vld sc_out sc_logic 1 outvld 20 } 
	{ out_pkts_dest_out sc_out sc_lv 6 signal 21 } 
	{ out_pkts_dest_out_ap_vld sc_out sc_logic 1 outvld 21 } 
	{ out_pkts_id_out sc_out sc_lv 5 signal 22 } 
	{ out_pkts_id_out_ap_vld sc_out sc_logic 1 outvld 22 } 
	{ in_pkts_last_3_1_out sc_out sc_lv 1 signal 23 } 
	{ in_pkts_last_3_1_out_ap_vld sc_out sc_logic 1 outvld 23 } 
	{ out_pkts_last_out sc_out sc_lv 1 signal 24 } 
	{ out_pkts_last_out_ap_vld sc_out sc_logic 1 outvld 24 } 
	{ out_pkts_user_out sc_out sc_lv 2 signal 25 } 
	{ out_pkts_user_out_ap_vld sc_out sc_logic 1 outvld 25 } 
	{ out_pkts_strb_out sc_out sc_lv 4 signal 26 } 
	{ out_pkts_strb_out_ap_vld sc_out sc_logic 1 outvld 26 } 
	{ out_pkts_keep_out sc_out sc_lv 4 signal 27 } 
	{ out_pkts_keep_out_ap_vld sc_out sc_logic 1 outvld 27 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_pkts_dest_0_0102", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "in_pkts_dest_0_0102", "role": "default" }} , 
 	{ "name": "in_pkts_id_0_0101", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "in_pkts_id_0_0101", "role": "default" }} , 
 	{ "name": "in_pkts_last_0_099", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "in_pkts_last_0_099", "role": "default" }} , 
 	{ "name": "in_pkts_user_0_098", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "in_pkts_user_0_098", "role": "default" }} , 
 	{ "name": "in_pkts_strb_0_097", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_pkts_strb_0_097", "role": "default" }} , 
 	{ "name": "in_pkts_keep_0_096", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_pkts_keep_0_096", "role": "default" }} , 
 	...
 	{ "name": "out_pkts_last_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "out_pkts_last_out", "role": "default" }} , 
 	{ "name": "out_pkts_last_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "out_pkts_last_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	in_pkts_dest_0_0102 { ap_none {  { in_pkts_dest_0_0102 in_data 0 6 } } }
	in_pkts_id_0_0101 { ap_none {  { in_pkts_id_0_0101 in_data 0 5 } } }
	in_pkts_last_0_099 { ap_none {  { in_pkts_last_0_099 in_data 0 1 } } }
	in_pkts_user_0_098 { ap_none {  { in_pkts_user_0_098 in_data 0 2 } } }
	in_pkts_strb_0_097 { ap_none {  { in_pkts_strb_0_097 in_data 0 4 } } }
	in_pkts_keep_0_096 { ap_none {  { in_pkts_keep_0_096 in_data 0 4 } } }
	...
	out_pkts_last_out { ap_vld {  { out_pkts_last_out out_data 1 1 }  { out_pkts_last_out_ap_vld out_vld 1 1 } } }
