set moduleName RNI_Pipeline_VITIS_LOOP_38_3
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "out_pkts_keep_reload", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out_pkts_last_reload", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_pkts_keep_reload sc_in sc_lv 4 signal 0 } 
	{ out_pkts_strb_reload sc_in sc_lv 4 signal 1 } 
	{ out_pkts_user_reload sc_in sc_lv 2 signal 2 } 
	{ out_pkts_last_reload sc_in sc_lv 1 signal 3 } 
	...
	{ NEURONS_MEMBRANE_address0 sc_out sc_lv 8 signal 13 } 
	{ NEURONS_MEMBRANE_ce0 sc_out sc_logic 1 signal 13 } 
	{ NEURONS_MEMBRANE_q0 sc_in sc_lv 16 signal 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_pkts_last_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "out_pkts_last_reload", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	out_pkts_last_reload { ap_none {  { out_pkts_last_reload in_data 0 1 } } }
