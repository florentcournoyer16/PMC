set moduleName RNI_Pipeline_WEIGHTS_LOOP1
set isTopModule 0
...
set C_modelName {RNI_Pipeline_WEIGHTS_LOOP1}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln153 int 15 regular  }
	{ zext_ln151 int 8 regular  }
	{ zext_ln153_1 int 15 regular  }
	{ trunc_ln2 int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln153", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln151", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln153_1", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln2", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln153 sc_in sc_lv 15 signal 0 } 
	{ zext_ln151 sc_in sc_lv 8 signal 1 } 
	{ zext_ln153_1 sc_in sc_lv 15 signal 2 } 
	{ trunc_ln2 sc_in sc_lv 9 signal 3 } 
	...
	{ NEURONS_MEMBRANE_address0 sc_out sc_lv 9 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln153", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln153", "role": "default" }} , 
 	{ "name": "zext_ln151", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln151", "role": "default" }} , 
 	{ "name": "zext_ln153_1", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln153_1", "role": "default" }} , 
 	{ "name": "trunc_ln2", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "trunc_ln2", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln153 { ap_none {  { zext_ln153 in_data 0 15 } } }
	zext_ln151 { ap_none {  { zext_ln151 in_data 0 8 } } }
	zext_ln153_1 { ap_none {  { zext_ln153_1 in_data 0 15 } } }
	trunc_ln2 { ap_none {  { trunc_ln2 in_data 0 9 } } }
