set moduleName RNI_Pipeline_WEIGHTS_LOOP2
set isTopModule 0
...
set C_modelName {RNI_Pipeline_WEIGHTS_LOOP2}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln122 int 15 regular  }
	{ zext_ln118 int 7 regular  }
	{ zext_ln122_1 int 15 regular  }
	{ trunc_ln7 int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln122", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln118", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln122_1", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln7", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln122 sc_in sc_lv 15 signal 0 } 
	{ zext_ln118 sc_in sc_lv 7 signal 1 } 
	{ zext_ln122_1 sc_in sc_lv 15 signal 2 } 
	{ trunc_ln7 sc_in sc_lv 9 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln122", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln122", "role": "default" }} , 
 	{ "name": "zext_ln118", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln118", "role": "default" }} , 
 	{ "name": "zext_ln122_1", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln122_1", "role": "default" }} , 
 	{ "name": "trunc_ln7", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "trunc_ln7", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln122 { ap_none {  { zext_ln122 in_data 0 15 } } }
	zext_ln118 { ap_none {  { zext_ln118 in_data 0 7 } } }
	zext_ln122_1 { ap_none {  { zext_ln122_1 in_data 0 15 } } }
	trunc_ln7 { ap_none {  { trunc_ln7 in_data 0 9 } } }
