set moduleName RNI_Pipeline_WEIGHTS_LOOP4
set isTopModule 0
...
set C_modelName {RNI_Pipeline_WEIGHTS_LOOP4}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln146 int 15 regular  }
	{ zext_ln142 int 9 regular  }
	{ zext_ln146_1 int 15 regular  }
	{ trunc_ln10 int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln146", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln142", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln146_1", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln10", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln146 sc_in sc_lv 15 signal 0 } 
	{ zext_ln142 sc_in sc_lv 9 signal 1 } 
	{ zext_ln146_1 sc_in sc_lv 15 signal 2 } 
	{ trunc_ln10 sc_in sc_lv 9 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln146", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln146", "role": "default" }} , 
 	{ "name": "zext_ln142", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "zext_ln142", "role": "default" }} , 
 	{ "name": "zext_ln146_1", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln146_1", "role": "default" }} , 
 	{ "name": "trunc_ln10", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "trunc_ln10", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln146 { ap_none {  { zext_ln146 in_data 0 15 } } }
	zext_ln142 { ap_none {  { zext_ln142 in_data 0 9 } } }
	zext_ln146_1 { ap_none {  { zext_ln146_1 in_data 0 15 } } }
	trunc_ln10 { ap_none {  { trunc_ln10 in_data 0 9 } } }
