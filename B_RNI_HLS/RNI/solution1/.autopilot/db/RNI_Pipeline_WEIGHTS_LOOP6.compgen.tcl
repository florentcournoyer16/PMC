...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { NEURONS_MEMBRANE_address0 { O 9 vector } NEURONS_MEMBRANE_ce0 { O 1 bit } NEURONS_MEMBRANE_we0 { O 1 bit } NEURONS_MEMBRANE_d0 { O 16 vector } NEURONS_MEMBRANE_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln170_1 \
    op interface \
    ports { zext_ln170_1 { I 15 vector } } \
} "
}
