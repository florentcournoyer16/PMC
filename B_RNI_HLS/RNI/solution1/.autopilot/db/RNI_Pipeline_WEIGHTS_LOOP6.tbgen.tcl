set moduleName RNI_Pipeline_WEIGHTS_LOOP6
set isTopModule 0
...
set C_modelName {RNI_Pipeline_WEIGHTS_LOOP6}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln170 int 15 regular  }
	{ zext_ln166 int 9 regular  }
	{ zext_ln170_1 int 15 regular  }
	{ trunc_ln13 int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln170", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln166", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln170_1", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln13", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln170 sc_in sc_lv 15 signal 0 } 
	{ zext_ln166 sc_in sc_lv 9 signal 1 } 
	{ zext_ln170_1 sc_in sc_lv 15 signal 2 } 
	{ trunc_ln13 sc_in sc_lv 9 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln170", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln170", "role": "default" }} , 
 	{ "name": "zext_ln166", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "zext_ln166", "role": "default" }} , 
 	{ "name": "zext_ln170_1", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln170_1", "role": "default" }} , 
 	{ "name": "trunc_ln13", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "trunc_ln13", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln170 { ap_none {  { zext_ln170 in_data 0 15 } } }
	zext_ln166 { ap_none {  { zext_ln166 in_data 0 9 } } }
	zext_ln170_1 { ap_none {  { zext_ln170_1 in_data 0 15 } } }
	trunc_ln13 { ap_none {  { trunc_ln13 in_data 0 9 } } }
