...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename WEIGHTS \
    op interface \
    ports { WEIGHTS_address0 { O 14 vector } WEIGHTS_ce0 { O 1 bit } WEIGHTS_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln155_1 \
    op interface \
    ports { zext_ln155_1 { I 14 vector } } \
} "
}
