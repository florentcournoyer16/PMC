...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename RNI_func_control_axilite \
			name RNI_func_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler RNI_func_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_stream_TREADY { I 1 bit } output_stream_TVALID { O 1 bit } output_stream_TDEST { O 6 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 16
set RegSliceName RNI_func_regslice_both
set RegSliceInstName RNI_func_regslice_both_U
set CoreName ap_simcore_RNI_func_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set InstName RNI_func_flow_control_loop_pipe_U
set CompName RNI_func_flow_control_loop_pipe
