...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { NEURONS_STATE_address0 { O 9 vector } NEURONS_STATE_ce0 { O 1 bit } NEURONS_STATE_we0 { O 1 bit } NEURONS_STATE_d0 { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_neuron_index \
    op interface \
    ports { neuron_index { I 9 vector } } \
} "
}
