set moduleName inner_layer_Pipeline_NEURONS_STATE_RESET_LOOP
set isTopModule 0
...
set C_modelArgList {
	...
	{ neuron_index int 9 regular  }
	{ NEURONS_STATE int 1 regular {array 424 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "neuron_state_index", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "neuron_index", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ neuron_state_index sc_in sc_lv 9 signal 0 } 
	{ neuron_index sc_in sc_lv 9 signal 1 } 
	{ NEURONS_STATE_address0 sc_out sc_lv 9 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "neuron_index", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "neuron_index", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	neuron_index { ap_none {  { neuron_index in_data 0 9 } } }
	NEURONS_STATE { ap_memory {  { NEURONS_STATE_address0 mem_address 1 9 }  { NEURONS_STATE_ce0 mem_ce 1 1 }  { NEURONS_STATE_we0 mem_we 1 1 }  { NEURONS_STATE_d0 mem_din 1 1 } } }
}
