...
set C_modelArgList {
	{ zext_ln119 int 15 regular  }
	{ neuron_index_1 int 9 regular  }
	{ zext_ln119_1 int 15 regular  }
	{ neuron_state_index int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln119", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "neuron_index_1", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln119_1", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "neuron_state_index", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln119 sc_in sc_lv 15 signal 0 } 
	{ neuron_index_1 sc_in sc_lv 9 signal 1 } 
	{ zext_ln119_1 sc_in sc_lv 15 signal 2 } 
	{ neuron_state_index sc_in sc_lv 9 signal 3 } 
	{ trunc_ln sc_in sc_lv 9 signal 4 } 
	{ NEURONS_STATE_address0 sc_out sc_lv 9 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln119", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln119", "role": "default" }} , 
 	{ "name": "neuron_index_1", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "neuron_index_1", "role": "default" }} , 
 	{ "name": "zext_ln119_1", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln119_1", "role": "default" }} , 
 	{ "name": "neuron_state_index", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "neuron_state_index", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln119 { ap_none {  { zext_ln119 in_data 0 15 } } }
	neuron_index_1 { ap_none {  { neuron_index_1 in_data 0 9 } } }
	zext_ln119_1 { ap_none {  { zext_ln119_1 in_data 0 15 } } }
	neuron_state_index { ap_none {  { neuron_state_index in_data 0 9 } } }
