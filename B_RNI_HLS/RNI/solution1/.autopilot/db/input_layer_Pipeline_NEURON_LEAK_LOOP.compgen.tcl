...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_membrane_leak_accumulator_out \
    op interface \
    ports { membrane_leak_accumulator_out { O 16 vector } membrane_leak_accumulator_out_ap_vld { O 1 bit } } \
} "
}
