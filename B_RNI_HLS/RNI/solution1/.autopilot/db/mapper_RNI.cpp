...
auto* sinput_stream_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_input_stream_V_dest_V);
  ...
  char* __xlx_output_stream_V_data_V_input_buffer= new char[ap_apatb_output_stream_V_data_V_cap_bc];
auto* soutput_stream_V_data_V = createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_data_V);
...
auto* soutput_stream_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_dest_V);
  // DUT call
  RNI(sinput_stream_V_data_V->data<char>(), sinput_stream_V_keep_V->data<char>(), sinput_stream_V_strb_V->data<char>(), sinput_stream_V_user_V->data<char>(), sinput_stream_V_last_V->data<char>(), sinput_stream_V_id_V->data<char>(), sinput_stream_V_dest_V->data<char>(), soutput_stream_V_data_V->data<char>(), soutput_stream_V_keep_V->data<char>(), soutput_stream_V_strb_V->data<char>(), soutput_stream_V_user_V->data<char>(), soutput_stream_V_last_V->data<char>(), soutput_stream_V_id_V->data<char>(), soutput_stream_V_dest_V->data<char>());
sinput_stream_V_data_V->transfer((hls::stream<char>*)__xlx_apatb_param_input_stream_V_data_V);
...
soutput_stream_V_data_V->transfer((hls::stream<char>*)__xlx_apatb_param_output_stream_V_data_V);
