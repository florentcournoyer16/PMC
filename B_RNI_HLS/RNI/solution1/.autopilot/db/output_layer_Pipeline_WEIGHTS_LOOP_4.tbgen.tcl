set moduleName output_layer_Pipeline_WEIGHTS_LOOP_4
set isTopModule 0
...
set C_modelName {output_layer_Pipeline_WEIGHTS_LOOP_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln141 int 14 regular  }
	{ zext_ln138 int 5 regular  }
	{ zext_ln141_1 int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln141", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln138", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln141_1", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln141 sc_in sc_lv 14 signal 0 } 
	{ zext_ln138 sc_in sc_lv 5 signal 1 } 
	{ zext_ln141_1 sc_in sc_lv 14 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln141", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "zext_ln141", "role": "default" }} , 
 	{ "name": "zext_ln138", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln138", "role": "default" }} , 
 	{ "name": "zext_ln141_1", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "zext_ln141_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln141 { ap_none {  { zext_ln141 in_data 0 14 } } }
	zext_ln138 { ap_none {  { zext_ln138 in_data 0 5 } } }
	zext_ln141_1 { ap_none {  { zext_ln141_1 in_data 0 14 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln149 int 14 regular  }
	{ zext_ln146 int 5 regular  }
	{ zext_ln149_1 int 14 regular  }
	{ trunc_ln int 8 regular  }
	{ NEURONS_STATE int 1 regular {array 244 { 1 3 } 1 1 } {global 0}  }
	{ NEURONS_MEMBRANE int 16 regular {array 244 { 2 3 } 1 1 } {global 2}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln149", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln146", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln149_1", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "NEURONS_STATE", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "NEURONS_MEMBRANE", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE", "extern" : 0} ]}
# RTL Port declarations: 
...
set portList { 
	...
	{ ap_idle sc_out sc_logic 1 done -1 } 
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ zext_ln149 sc_in sc_lv 14 signal 0 } 
	{ zext_ln146 sc_in sc_lv 5 signal 1 } 
	{ zext_ln149_1 sc_in sc_lv 14 signal 2 } 
	{ trunc_ln sc_in sc_lv 8 signal 3 } 
	{ NEURONS_STATE_address0 sc_out sc_lv 8 signal 4 } 
	{ NEURONS_STATE_ce0 sc_out sc_logic 1 signal 4 } 
	{ NEURONS_STATE_q0 sc_in sc_lv 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ap_idle", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "done", "bundle":{"name": "ap_idle", "role": "default" }} , 
 	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	{ "name": "zext_ln149", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "zext_ln149", "role": "default" }} , 
 	{ "name": "zext_ln146", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln146", "role": "default" }} , 
 	{ "name": "zext_ln149_1", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "zext_ln149_1", "role": "default" }} , 
 	{ "name": "trunc_ln", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "trunc_ln", "role": "default" }} , 
 	{ "name": "NEURONS_STATE_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "NEURONS_STATE", "role": "address0" }} , 
 	{ "name": "NEURONS_STATE_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "NEURONS_STATE", "role": "ce0" }} , 
 	{ "name": "NEURONS_STATE_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "NEURONS_STATE", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	zext_ln149 { ap_none {  { zext_ln149 in_data 0 14 } } }
	zext_ln146 { ap_none {  { zext_ln146 in_data 0 5 } } }
	zext_ln149_1 { ap_none {  { zext_ln149_1 in_data 0 14 } } }
	trunc_ln { ap_none {  { trunc_ln in_data 0 8 } } }
	NEURONS_STATE { ap_memory {  { NEURONS_STATE_address0 mem_address 1 8 }  { NEURONS_STATE_ce0 mem_ce 1 1 }  { NEURONS_STATE_q0 in_data 0 1 } } }
	NEURONS_MEMBRANE { ap_memory {  { NEURONS_MEMBRANE_address0 mem_address 1 8 }  { NEURONS_MEMBRANE_ce0 mem_ce 1 1 }  { NEURONS_MEMBRANE_we0 mem_we 1 1 }  { NEURONS_MEMBRANE_d0 mem_din 1 16 }  { NEURONS_MEMBRANE_q0 in_data 0 16 } } }
}
