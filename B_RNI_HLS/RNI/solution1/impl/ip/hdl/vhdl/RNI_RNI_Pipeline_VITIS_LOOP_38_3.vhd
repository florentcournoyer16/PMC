...
entity RNI_RNI_Pipeline_VITIS_LOOP_38_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of RNI_RNI_Pipeline_VITIS_LOOP_38_3 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln38_fu_170_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln38_fu_164_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_78 <= add_ln38_fu_170_p2;
    ...
    NEURONS_MEMBRANE_address0 <= i_1_cast_fu_176_p1(8 - 1 downto 0);
    ...
    add_ln38_fu_170_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv8_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln38_fu_164_p2)
    begin
        if (((icmp_ln38_fu_164_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln38_fu_164_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv8_F4) else "0";
    ...
    out_stream_TDEST <= out_pkts_dest_reload;
    out_stream_TID <= out_pkts_id_reload;
    out_stream_TKEEP <= out_pkts_keep_reload;
    out_stream_TLAST <= out_pkts_last_reload;
    out_stream_TSTRB <= out_pkts_strb_reload;
    out_stream_TUSER <= out_pkts_user_reload;
