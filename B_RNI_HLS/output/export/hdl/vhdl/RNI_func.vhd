...
architecture behav of RNI_func is 
    ...
    "RNI_func_RNI_func,hls_ip_2023_1_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=40,HLS_SYN_LUT=84,HLS_VERSION=2023_1_1}";
    ...
    signal input_buffer_last_fu_133_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    regslice_both_input_stream_V_data_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_stream_V_keep_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_stream_V_strb_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_stream_V_user_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_stream_V_last_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_stream_V_id_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 5)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_input_stream_V_dest_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 6)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_stream_V_data_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_stream_V_keep_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_stream_V_strb_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_stream_V_user_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_stream_V_last_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_stream_V_id_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 5)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_stream_V_dest_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 6)
    port map (
        ap_clk => ap_clk,
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, input_buffer_last_fu_133_p1, ap_start_int)
    begin
        if (((input_buffer_last_fu_133_p1 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    input_buffer_last_fu_133_p1 <= input_stream_TLAST_int_regslice;
