...
void output_layer(BASE_TYPE output_list[OUTPUT_LAYER_LENGHT]);
 ...
 void RNI_func (
 	hls::stream< ap_axis< BASE_TYPE_LENGHT * INPUT_LAYER_LENGHT, 2, 5, 6 > > &input_stream,
 	hls::stream< ap_axis< BASE_TYPE_LENGHT * INPUT_LAYER_LENGHT, 2, 5, 6 > > &output_stream
 )
 {
 ...
 #pragma HLS INTERFACE s_axilite port=return
 	...
 	main_loop: while(true)
    	{
 		ap_axis< BASE_TYPE_LENGHT * INPUT_LAYER_LENGHT, 2, 5, 6 > input_buffer;
