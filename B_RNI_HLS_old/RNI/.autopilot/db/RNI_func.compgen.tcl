...
set name RNI_func_mul_32ns_32ns_64_2_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_r_TVALID { I 1 bit } in_r_TREADY { O 1 bit } in_r_TDEST { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TREADY { I 1 bit } out_r_TVALID { O 1 bit } out_r_TDEST { O 6 vector } } \
} "
} else {
