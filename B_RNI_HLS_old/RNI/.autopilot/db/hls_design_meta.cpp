...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("out_r_TDATA", 64, hls_out, 7, "axis", "out_data", 1),
	Port_Property("out_r_TVALID", 1, hls_out, 13, "axis", "out_vld", 1),
	Port_Property("out_r_TKEEP", 8, hls_out, 8, "axis", "out_data", 1),
	Port_Property("out_r_TSTRB", 8, hls_out, 9, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "RNI_func";
