...
auto* sin_V_user_V = createStream((hls::stream<char>*)__xlx_apatb_param_in_V_user_V);
auto* sin_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_in_V_last_V);
auto* sin_V_id_V = createStream((hls::stream<char>*)__xlx_apatb_param_in_V_id_V);
auto* sin_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_in_V_dest_V);
  //Create input buffer for out_V_data_V
  ap_apatb_out_V_data_V_cap_bc = __xlx_out_V_data_V_V_size_Reader.read_size();
  long long* __xlx_out_V_data_V_input_buffer= new long long[ap_apatb_out_V_data_V_cap_bc];
auto* sout_V_data_V = createStream((hls::stream<long long>*)__xlx_apatb_param_out_V_data_V);
...
auto* sout_V_user_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_V_user_V);
...
auto* sout_V_id_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_V_id_V);
...
auto* sout_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_V_dest_V);
  // DUT call
  RNI_func(sin_V_data_V->data<long long>(), sin_V_keep_V->data<char>(), sin_V_strb_V->data<char>(), sin_V_user_V->data<char>(), sin_V_last_V->data<char>(), sin_V_id_V->data<char>(), sin_V_dest_V->data<char>(), sout_V_data_V->data<long long>(), sout_V_keep_V->data<char>(), sout_V_strb_V->data<char>(), sout_V_user_V->data<char>(), sout_V_last_V->data<char>(), sout_V_id_V->data<char>(), sout_V_dest_V->data<char>());
sin_V_data_V->transfer((hls::stream<long long>*)__xlx_apatb_param_in_V_data_V);
...
sin_V_user_V->transfer((hls::stream<char>*)__xlx_apatb_param_in_V_user_V);
sin_V_last_V->transfer((hls::stream<char>*)__xlx_apatb_param_in_V_last_V);
sin_V_id_V->transfer((hls::stream<char>*)__xlx_apatb_param_in_V_id_V);
sin_V_dest_V->transfer((hls::stream<char>*)__xlx_apatb_param_in_V_dest_V);
sout_V_data_V->transfer((hls::stream<long long>*)__xlx_apatb_param_out_V_data_V);
...
sout_V_user_V->transfer((hls::stream<char>*)__xlx_apatb_param_out_V_user_V);
sout_V_last_V->transfer((hls::stream<char>*)__xlx_apatb_param_out_V_last_V);
sout_V_id_V->transfer((hls::stream<char>*)__xlx_apatb_param_out_V_id_V);
sout_V_dest_V->transfer((hls::stream<char>*)__xlx_apatb_param_out_V_dest_V);
}
