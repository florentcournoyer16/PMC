...
architecture behav of RNI_func is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "RNI_func_RNI_func,hls_ip_2023_1_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.912000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=237,HLS_SYN_LUT=132,HLS_VERSION=2023_1_1}";
    ...
    signal p_3_fu_140_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal in_r_TDATA_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal out_r_TDATA_blk_n : STD_LOGIC;
    signal p_s_reg_176 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal p_1_reg_181 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_2_reg_186 : STD_LOGIC_VECTOR (1 downto 0);
    signal p_3_reg_191 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_4_reg_196 : STD_LOGIC_VECTOR (4 downto 0);
    signal p_5_reg_201 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal trunc_ln34_fu_152_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal lshr_ln_fu_161_p4 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_fu_119_p00 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_119_p10 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component RNI_func_mul_32ns_32ns_64_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component RNI_func_control_s_axi IS
    generic (
    ...
    component RNI_func_flow_control_loop_pipe IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component RNI_func_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    control_s_axi_U : component RNI_func_control_s_axi
    generic map (
    ...
    mul_32ns_32ns_64_2_1_U1 : component RNI_func_mul_32ns_32ns_64_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    flow_control_loop_pipe_U : component RNI_func_flow_control_loop_pipe
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => ap_start,
    ...
    regslice_both_in_r_V_data_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_r_V_keep_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_r_V_strb_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_r_V_user_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_r_V_last_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_r_V_id_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 5)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_r_V_dest_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 6)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_r_V_data_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_fu_119_p2,
    ...
    regslice_both_out_r_V_keep_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_r_V_strb_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_r_V_user_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_r_V_last_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_r_V_id_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 5)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_r_V_dest_V_U : component RNI_func_regslice_both
    generic map (
        DataWidth => 6)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                p_1_reg_181 <= in_r_TSTRB_int_regslice;
                p_2_reg_186 <= in_r_TUSER_int_regslice;
                p_3_reg_191 <= in_r_TLAST_int_regslice;
                p_4_reg_196 <= in_r_TID_int_regslice;
                p_5_reg_201 <= in_r_TDEST_int_regslice;
                p_s_reg_176 <= in_r_TKEEP_int_regslice;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, regslice_both_out_r_V_data_V_U_apdone_blk, ap_loop_exit_ready_pp0_iter2_reg, ap_start_int, in_r_TVALID_int_regslice, out_r_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_loop_exit_ready_pp0_iter2_reg = ap_const_logic_1) and (regslice_both_out_r_V_data_V_U_apdone_blk = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_out_r_V_data_V_U_apdone_blk = ap_const_logic_1) or (out_r_TREADY_int_regslice = ap_const_logic_0))) or ((out_r_TREADY_int_regslice = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((in_r_TVALID_int_regslice = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, regslice_both_out_r_V_data_V_U_apdone_blk, ap_loop_exit_ready_pp0_iter2_reg, ap_start_int, in_r_TVALID_int_regslice, out_r_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_loop_exit_ready_pp0_iter2_reg = ap_const_logic_1) and (regslice_both_out_r_V_data_V_U_apdone_blk = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_out_r_V_data_V_U_apdone_blk = ap_const_logic_1) or (out_r_TREADY_int_regslice = ap_const_logic_0))) or ((out_r_TREADY_int_regslice = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((in_r_TVALID_int_regslice = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, regslice_both_out_r_V_data_V_U_apdone_blk, ap_loop_exit_ready_pp0_iter2_reg, ap_start_int, in_r_TVALID_int_regslice, out_r_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_loop_exit_ready_pp0_iter2_reg = ap_const_logic_1) and (regslice_both_out_r_V_data_V_U_apdone_blk = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_out_r_V_data_V_U_apdone_blk = ap_const_logic_1) or (out_r_TREADY_int_regslice = ap_const_logic_0))) or ((out_r_TREADY_int_regslice = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((in_r_TVALID_int_regslice = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;
    ...
    begin
                ap_block_state2_pp0_stage0_iter1 <= (out_r_TREADY_int_regslice = ap_const_logic_0);
    end process;


    ap_block_state3_pp0_stage0_iter2_assign_proc : process(regslice_both_out_r_V_data_V_U_apdone_blk, out_r_TREADY_int_regslice)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((regslice_both_out_r_V_data_V_U_apdone_blk = ap_const_logic_1) or (out_r_TREADY_int_regslice = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, p_3_fu_140_p1, ap_start_int)
    begin
        if (((p_3_fu_140_p1 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    grp_fu_119_p0 <= grp_fu_119_p00(32 - 1 downto 0);
    grp_fu_119_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln34_fu_152_p1),64));
    grp_fu_119_p1 <= grp_fu_119_p10(32 - 1 downto 0);
    grp_fu_119_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln_fu_161_p4),64));
    ...
    lshr_ln_fu_161_p4 <= in_r_TDATA_int_regslice(63 downto 32);
    ...
    p_3_fu_140_p1 <= in_r_TLAST_int_regslice;
    trunc_ln34_fu_152_p1 <= in_r_TDATA_int_regslice(32 - 1 downto 0);
end behav;
