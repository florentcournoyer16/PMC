...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "RNI_func.autotvin.dat"
	set constFileTvOut       "RNI_func.autotvout.dat"
	set constFileHdlTvIn     "RNI_func.autohdltvin.dat"
	set constFileHdlTvOut    "RNI_func.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
