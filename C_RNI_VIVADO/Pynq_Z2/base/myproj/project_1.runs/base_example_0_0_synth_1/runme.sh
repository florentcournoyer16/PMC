...
HD_PWD='/home/mohr0901/Documents/PMC/C_RNI_VIVADO/Pynq_Z2/base/myproj/project_1.runs/base_example_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_example_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_example_0_0.tcl
