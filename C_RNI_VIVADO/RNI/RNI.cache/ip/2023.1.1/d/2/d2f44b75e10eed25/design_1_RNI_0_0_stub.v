...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_RNI_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_control_AWADDR, 
  ...
  output_stream_TID)
/* synthesis syn_black_box black_box_pad_pin="s_axi_control_AWADDR[3:0],s_axi_control_AWVALID,s_axi_control_AWREADY,s_axi_control_WDATA[31:0],s_axi_control_WSTRB[3:0],s_axi_control_WVALID,s_axi_control_WREADY,s_axi_control_BRESP[1:0],s_axi_control_BVALID,s_axi_control_BREADY,s_axi_control_ARADDR[3:0],s_axi_control_ARVALID,s_axi_control_ARREADY,s_axi_control_RDATA[31:0],s_axi_control_RRESP[1:0],s_axi_control_RVALID,s_axi_control_RREADY,ap_rst_n,interrupt,input_stream_TVALID,input_stream_TREADY,input_stream_TDATA[63:0],input_stream_TDEST[5:0],input_stream_TKEEP[7:0],input_stream_TSTRB[7:0],input_stream_TUSER[1:0],input_stream_TLAST[0:0],input_stream_TID[4:0],output_stream_TVALID,output_stream_TREADY,output_stream_TDATA[63:0],output_stream_TDEST[5:0],output_stream_TKEEP[7:0],output_stream_TSTRB[7:0],output_stream_TUSER[1:0],output_stream_TLAST[0:0],output_stream_TID[4:0]" */
