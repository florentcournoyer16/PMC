...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LIGHT_MODULE.autotvin.dat"
	set constFileTvOut       "LIGHT_MODULE.autotvout.dat"
	set constFileHdlTvIn     "LIGHT_MODULE.autohdltvin.dat"
	set constFileHdlTvOut    "LIGHT_MODULE.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
