...
attribute shreg_extract : string;
    ...
    signal in_pixel_last_fu_140_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage1 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal stream_in_24_TDATA_blk_n : STD_LOGIC;
    signal stream_out_32_TDATA_blk_n : STD_LOGIC;
    signal empty_reg_214_3 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal grp_fu_109_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_reg_219 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_fu_119_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_5_reg_224 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln116_fu_129_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln116_reg_229 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln112_1_fu_155_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln112_fu_152_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln114_1_fu_168_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln114_fu_165_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal out_c1_fu_159_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal out_c2_fu_172_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_1_fu_192_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln118_fu_188_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_178_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((stream_in_24_TVALID = ap_const_logic_0) or (ap_start_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                empty_reg_214_3 <= stream_in_24_TUSER;
                tmp_3_reg_219 <= stream_in_24_TDATA(15 downto 8);
                tmp_5_reg_224 <= stream_in_24_TDATA(23 downto 16);
                trunc_ln116_reg_229 <= trunc_ln116_fu_129_p1;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_CS_fsm_state2, stream_in_24_TVALID, stream_out_32_TREADY, in_pixel_last_fu_140_p1)
    begin
        if ((not(((stream_out_32_TREADY = ap_const_logic_0) or (stream_in_24_TVALID = ap_const_logic_0))) and (in_pixel_last_fu_140_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_fu_109_p4 <= stream_in_24_TDATA(15 downto 8);
    grp_fu_119_p4 <= stream_in_24_TDATA(23 downto 16);
    in_pixel_last_fu_140_p1 <= stream_in_24_TLAST;
    out_c1_fu_159_p2 <= std_logic_vector(unsigned(zext_ln112_1_fu_155_p1) + unsigned(zext_ln112_fu_152_p1));
    out_c2_fu_172_p2 <= std_logic_vector(unsigned(zext_ln114_1_fu_168_p1) + unsigned(zext_ln114_fu_165_p1));
    ...
    stream_out_32_TDATA <= (((tmp_1_fu_192_p4 & trunc_ln118_fu_188_p1) & tmp_s_fu_178_p4) & trunc_ln116_reg_229);
    ...
    stream_out_32_TUSER <= (stream_in_24_TUSER or empty_reg_214_3);
    ...
    tmp_1_fu_192_p4 <= out_c2_fu_172_p2(8 downto 1);
    tmp_s_fu_178_p4 <= out_c1_fu_159_p2(8 downto 1);
    trunc_ln116_fu_129_p1 <= stream_in_24_TDATA(8 - 1 downto 0);
    trunc_ln118_fu_188_p1 <= stream_in_24_TDATA(8 - 1 downto 0);
    zext_ln112_1_fu_155_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_109_p4),9));
    zext_ln112_fu_152_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_3_reg_219),9));
    zext_ln114_1_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_119_p4),9));
    zext_ln114_fu_165_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_5_reg_224),9));
end behav;
