...
extern "C"
void pixel_unpack_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_pixel_unpack_hw(void* __xlx_apatb_param_stream_in_32_V_data_V, void* __xlx_apatb_param_stream_in_32_V_keep_V, void* __xlx_apatb_param_stream_in_32_V_strb_V, void* __xlx_apatb_param_stream_in_32_V_user_V, void* __xlx_apatb_param_stream_in_32_V_last_V, void* __xlx_apatb_param_stream_out_24_V_data_V, void* __xlx_apatb_param_stream_out_24_V_keep_V, void* __xlx_apatb_param_stream_out_24_V_strb_V, void* __xlx_apatb_param_stream_out_24_V_user_V, void* __xlx_apatb_param_stream_out_24_V_last_V, hls::sim::Byte<4> __xlx_apatb_param_mode)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "stream_in_32_V_data_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_stream_in_32_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_stream_in_32_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_stream_in_32_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_stream_in_32_V_data_V),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_stream_in_32_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_stream_in_32_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_stream_in_32_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_stream_in_32_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_stream_in_32_V_keep_V),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_stream_in_32_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_stream_in_32_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_stream_in_32_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_stream_in_32_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_stream_in_32_V_strb_V),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_stream_in_32_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_stream_in_32_V_user_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_stream_in_32_V_user_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_stream_in_32_V_user_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_stream_in_32_V_user_V),
#endif
  };
  port3.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_stream_in_32_V_user_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_stream_in_32_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_stream_in_32_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_stream_in_32_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_stream_in_32_V_last_V),
#endif
  };
  port4.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_stream_in_32_V_last_V;
