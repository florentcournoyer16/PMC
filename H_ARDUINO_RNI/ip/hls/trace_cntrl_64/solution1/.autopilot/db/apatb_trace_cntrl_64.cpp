...
extern "C"
void trace_cntrl_64_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, hls::sim::Byte<8>*, hls::sim::Byte<4>);

extern "C"
void apatb_trace_cntrl_64_hw(void* __xlx_apatb_param_trace_64_V_data_V, void* __xlx_apatb_param_trace_64_V_keep_V, void* __xlx_apatb_param_trace_64_V_strb_V, void* __xlx_apatb_param_trace_64_V_user_V, void* __xlx_apatb_param_trace_64_V_last_V, void* __xlx_apatb_param_trace_64_V_id_V, void* __xlx_apatb_param_trace_64_V_dest_V, void* __xlx_apatb_param_capture_64_V_data_V, void* __xlx_apatb_param_capture_64_V_keep_V, void* __xlx_apatb_param_capture_64_V_strb_V, void* __xlx_apatb_param_capture_64_V_user_V, void* __xlx_apatb_param_capture_64_V_last_V, void* __xlx_apatb_param_capture_64_V_id_V, void* __xlx_apatb_param_capture_64_V_dest_V, hls::sim::Byte<8>* __xlx_apatb_param_trigger, hls::sim::Byte<4> __xlx_apatb_param_length_r)
{
  static hls::sim::Stream<hls::sim::Byte<8>> port0 {
    .width = 64,
    .name = "trace_64_V_data_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_trace_64_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_trace_64_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_trace_64_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_trace_64_V_data_V),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_trace_64_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_trace_64_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_trace_64_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_trace_64_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_trace_64_V_keep_V),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_trace_64_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_trace_64_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_trace_64_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_trace_64_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_trace_64_V_strb_V),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_trace_64_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_trace_64_V_user_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_trace_64_V_user_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_trace_64_V_user_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_trace_64_V_user_V),
#endif
  };
  port3.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_trace_64_V_user_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_trace_64_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_trace_64_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_trace_64_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_trace_64_V_last_V),
#endif
  };
  port4.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_trace_64_V_last_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_trace_64_V_id_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_trace_64_V_id_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_trace_64_V_id_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_trace_64_V_id_V),
#endif
  };
  port5.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_trace_64_V_id_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_trace_64_V_dest_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_trace_64_V_dest_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_trace_64_V_dest_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_trace_64_V_dest_V),
#endif
  };
  port6.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_trace_64_V_dest_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_capture_64_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_capture_64_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_capture_64_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_capture_64_V_data_V),
#endif
  };
  port7.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_capture_64_V_data_V;
  port7.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_capture_64_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_capture_64_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_capture_64_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_capture_64_V_keep_V),
#endif
  };
  port8.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_capture_64_V_keep_V;
  port8.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_capture_64_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_capture_64_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_capture_64_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_capture_64_V_strb_V),
#endif
  };
  port9.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_capture_64_V_strb_V;
  port9.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_capture_64_V_user_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_capture_64_V_user_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_capture_64_V_user_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_capture_64_V_user_V),
#endif
  };
  port10.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_capture_64_V_user_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_capture_64_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_capture_64_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_capture_64_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_capture_64_V_last_V),
#endif
  };
  port11.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_capture_64_V_last_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_capture_64_V_id_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_capture_64_V_id_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_capture_64_V_id_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_capture_64_V_id_V),
#endif
  };
  port12.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_capture_64_V_id_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_capture_64_V_dest_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_capture_64_V_dest_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_capture_64_V_dest_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_capture_64_V_dest_V),
#endif
  };
  port13.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_capture_64_V_dest_V;
