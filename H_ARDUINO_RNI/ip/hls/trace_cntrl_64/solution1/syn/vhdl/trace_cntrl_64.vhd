...
architecture behav of trace_cntrl_64 is 
    ...
    "trace_cntrl_64_trace_cntrl_64,hls_ip_2023_1_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.082000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=430,HLS_SYN_LUT=695,HLS_VERSION=2023_1_1}";
    ...
    signal empty_fu_123_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal empty_reg_138 : STD_LOGIC_VECTOR (31 downto 0);
    signal sub_fu_127_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal sub_reg_143 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start : STD_LOGIC;
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done : STD_LOGIC;
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_idle : STD_LOGIC;
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_ready : STD_LOGIC;
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TREADY : STD_LOGIC;
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID : STD_LOGIC;
    ...
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_trace_64_TREADY : STD_LOGIC;
    signal grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88 : component trace_cntrl_64_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start,
        ap_done => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done,
        ap_idle => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_idle,
        ap_ready => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_ready,
        trace_64_TVALID => trace_64_TVALID_int_regslice,
        capture_64_TREADY => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TREADY,
        length_r => length_r_read_reg_133,
        sub => sub_reg_143,
        capture_64_TDATA => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDATA,
        capture_64_TVALID => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
        capture_64_TKEEP => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TKEEP,
        capture_64_TSTRB => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TSTRB,
        capture_64_TUSER => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TUSER,
        capture_64_TLAST => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TLAST,
        capture_64_TID => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TID,
        capture_64_TDEST => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDEST,
        trace_64_TDATA => trace_64_TDATA_int_regslice,
        trace_64_TREADY => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_trace_64_TREADY,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDATA,
        vld_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TKEEP,
        vld_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TSTRB,
        vld_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TUSER,
        vld_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TLAST,
        vld_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TID,
        vld_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TDEST,
        vld_in => grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID,
    ...
    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_ready = ap_const_logic_1)) then 
                    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                empty_reg_138 <= empty_fu_123_p1;
                length_r_read_reg_133 <= length_r;
                sub_reg_143 <= sub_fu_127_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_capture_64_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done)
    begin
        if ((grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_done = ap_const_logic_0)) then 
    ...
    capture_64_TVALID_int_regslice <= grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TVALID;
    empty_fu_123_p1 <= trigger(32 - 1 downto 0);
    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start <= grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_ap_start_reg;
    grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_capture_64_TREADY <= (capture_64_TREADY_int_regslice and ap_CS_fsm_state3);
    sub_fu_127_p2 <= std_logic_vector(unsigned(length_r) + unsigned(ap_const_lv32_FFFFFFFF));
    trace_64_TREADY <= regslice_both_trace_64_V_data_V_U_ack_in;

    trace_64_TREADY_int_regslice_assign_proc : process(grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_trace_64_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            trace_64_TREADY_int_regslice <= grp_trace_cntrl_64_Pipeline_VITIS_LOOP_27_1_fu_88_trace_64_TREADY;
        else 
