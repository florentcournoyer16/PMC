set moduleName RNI_Pipeline_VITIS_LOOP_68_1
set isTopModule 0
...
set C_modelName {RNI_Pipeline_VITIS_LOOP_68_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ sext_ln68 int 62 regular  }
	{ NEURONS_MEM int 32 regular {array 14 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln68", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "NEURONS_MEM", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ NEURONS_MEM_address0 sc_out sc_lv 4 signal 2 } 
	{ NEURONS_MEM_ce0 sc_out sc_logic 1 signal 2 } 
	{ NEURONS_MEM_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	NEURONS_MEM { ap_memory {  { NEURONS_MEM_address0 mem_address 1 4 }  { NEURONS_MEM_ce0 mem_ce 1 1 }  { NEURONS_MEM_q0 mem_dout 0 32 } } }
}
