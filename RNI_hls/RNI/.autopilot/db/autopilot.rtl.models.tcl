set SynModuleInfo {
  {SRCNAME RNI_Pipeline_WEIGHTS_LOOP MODELNAME RNI_Pipeline_WEIGHTS_LOOP RTLNAME RNI_RNI_Pipeline_WEIGHTS_LOOP
    SUBMODULES {
      {MODELNAME RNI_mul_11s_32s_32_2_1 RTLNAME RNI_mul_11s_32s_32_2_1 BINDTYPE op TYPE mul IMPL auto LATENCY 1 ALLOW_PRAGMA 1}
  ...
  {SRCNAME RNI MODELNAME RNI RTLNAME RNI IS_TOP 1
    SUBMODULES {
      {MODELNAME RNI_mux_4_2_10_1_1 RTLNAME RNI_mux_4_2_10_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
