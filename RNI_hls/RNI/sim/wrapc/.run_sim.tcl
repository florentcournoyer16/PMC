...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "RNI.autotvin.dat"
	set constFileTvOut       "RNI.autotvout.dat"
	set constFileHdlTvIn     "RNI.autohdltvin.dat"
	set constFileHdlTvOut    "RNI.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
